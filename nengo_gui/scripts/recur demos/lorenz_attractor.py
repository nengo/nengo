...
# $$
#
# Since $x_2$ is centered around approximately $\rho$, and since NEF ensembles
# are usually optimized to represent values within a certain radius of the origin,
...
# $$
#
# For more information, see http://compneuro.uwaterloo.ca/publications/eliasmith2005b.html

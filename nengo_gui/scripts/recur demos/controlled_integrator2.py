...
# This demo implements a controlled one-dimensional neural integrator that is
# functionally the same as the controlled integrator in the previous example.
# However, the control signal is zero for integration, less than one for
# low-pass filtering, and greater than 1 for saturation. This behavior maps

...
class NeuronType(FrozenObject):
    ...
    def _j_intercepts_to_gain(self, max_j, intercepts):
        ...
        gain : ndarray
            The required gains.
        """
        return max_j / (self.max_x - intercepts)
    ...
    def _gain_intercepts_to_j(self, gain, intercepts):
        ...
        max_j : ndarray
            The currents that produce the desired max rates in the neuron.
        """
        return gain * (self.max_x - intercepts)
    ...
    def max_rates_intercepts(self, gain, bias):
        ...
        max_rates = self.rates(self.max_x, gain, bias).squeeze(axis=0)
